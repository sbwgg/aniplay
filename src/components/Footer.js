        ...
        <div>
            <footer className="bg-[#151518] mt-10">
                    ...
                    <div className="lg:flex lg:justify-between">
                        <div className="mb-6 lg:mb-0">
                            <Link href="/" className="flex items-center w-fit">
                                <p className={`aniplay self-center text-3xl font-medium whitespace-nowrap dark:text-white`}>bertoo.pro</p>
                            </Link>
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">bertoo.pro</Link> | Made by <span className="font-bold" >Bertoo</span>
                    </span>
